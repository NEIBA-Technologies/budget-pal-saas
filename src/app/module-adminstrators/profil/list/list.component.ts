...
import { EditComponentComponent } from '../../users/components/edit-component/edit-component.component';
...
export class ListComponent  extends Pagination implements OnInit {
  ...
  onShowItem(rowItem: any) {
    this._drawerService.create({
      ...
      nzPlacement: "right",
      nzSize: "large",
      nzTitle: "Detail d'un profil",
      nzMaskClosable: false,
      nzCloseOnNavigation: false,
      nzClosable: true,
      nzWrapClassName: "drawer-edit",
